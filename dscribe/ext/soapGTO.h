...
void getP(double* Ps, double* Cs, int Ns, int Ts, int Hs, int lMax, bool crossover);
void soapGTO(py::array_t<double> c, py::array_t<double> Apos, py::array_t<double> Hpos, py::array_t<double> alphas, py::array_t<double> betas, py::array_t<int> atomicNumbers, py::array_t<int> orderedSpeciesArr, double rCut, double cutoffPadding, int totalAN, int Nt, int Ns, int lMax, int Hs, double eta, bool crossover, string average);
