...
if __name__ == "__main__":
    ...
    mat = np.loadtxt("tesseralMatDerY.mat", dtype = "U16384")
#    mat = np.loadtxt("test.txt", dtype = "U16384") # Change me
    print(mat.shape)
    evalf_mat = evaluate_matrix(mat)
    no_pow_mat = remove_power_in_matrix(evalf_mat)
    np.savetxt("tesseral_mat_nopowDevY.txt", no_pow_mat, fmt="%s",delimiter=", ")
    np.save("tesseral_mat_nopowDevY.npy", no_pow_mat)
